	...
	return (
		<>
			<div className="relative flex flex-col items-start justify-center text-left h-full gap-6 text-white">
				<h2 className="text-5xl font-semibold font-quantico mb-2 mt-4">Link Cost Metric</h2>
	...
	return (
		<>
			<div className="relative flex flex-col items-start justify-center text-left h-full gap-6 text-white">
				...
				<h2 className="text-5xl font-semibold font-quantico mb-2 mt-4">Path Cost Sum</h2>
					<ul className="list-[square] list-inside leading-relaxed text-lg marker:text-2xl marker:text-white marker:mr-2 space-y-3">
					...
					<li>OSPF will choose the path with the lowest total cost, which in this case is R1 → R5 → R3 with a total cost of <strong>2</strong>.</li>
					</ul>
				</div>
