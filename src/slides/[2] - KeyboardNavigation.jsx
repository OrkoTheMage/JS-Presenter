...
export default function KeyboardNavigation() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-white">
      ...
      <div className="flex items-center gap-16">
        <div className="flex flex-col items-center gap-6">
          <div className="flex gap-4">
            <div className={keyBindClass}>←</div>
            <div className={keyBindClass}>→</div>
          </div>
      ...
      <div className="mt-16 p-8 bg-white/5 rounded-xl border border-white/20 max-w-2xl">
        <p className="text-xl text-center text-gray-300">
          Use <span className={keyBindClass}>↑</span> <span className={keyBindClass}>↓</span> to explore the sub-slide below!
        </p>
      </div>
    </div>
  )
      ...
      <div className="grid grid-cols-2 gap-6 text-lg">
        <div className="flex items-center gap-4 p-4 bg-white/10 rounded-lg">
          <div className="flex gap-2">
            <span className={keyBindBlockClass}>← →</span>
          </div>
