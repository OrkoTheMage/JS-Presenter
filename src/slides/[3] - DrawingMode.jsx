    ...
    <div className="flex flex-col items-center justify-center h-full text-gray-100">
      ...
      <div className="flex gap-12 items-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-2">Press</p>
          <span className={`${keyBindClass} text-3xl px-4 py-2`}> D </span>
          <p className="text-lg text-gray-400 mt-2">to enable</p>
        </div>
        ...
        <div className="text-center">
          <div className="text-6xl mb-4">🗑️</div>
          <p className="text-xl text-gray-300 mb-2">Press</p>
          <span className={`${keyBindClass} text-3xl px-4 py-2`}> C </span>
          <p className="text-lg text-gray-400 mt-2">to clear</p>
        </div>
      </div>

      <div className="mt-16 p-6 bg-indigo-500/10 rounded-xl border border-indigo-400/30">
