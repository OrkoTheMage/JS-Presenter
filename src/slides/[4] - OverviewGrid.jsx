  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-white">
      ...
      <div className="relative mb-12">
        <div className="grid grid-cols-4 gap-4 p-8 bg-white/5 rounded-2xl border border-white/20">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-white">
      ...
      <div className="flex flex-col gap-6 max-w-3xl">
        <div className="flex items-start gap-6 p-6 bg-white/10 rounded-xl border border-white/20">
