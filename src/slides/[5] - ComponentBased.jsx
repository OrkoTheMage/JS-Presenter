    ...
    <div className="flex flex-col items-center justify-center h-full text-white">
      ...
      <div className="flex gap-8 mb-12">
        ...
        <div className="flex flex-col gap-3">
          <div className="px-4 py-2 bg-white/10 rounded font-mono text-sm">
            [1] - Title.jsx
          </div>
          <div className="px-4 py-2 bg-white/10 rounded font-mono text-sm">
            [2] - Features.jsx
      ...
      <div className="p-6 bg-white/5 rounded-xl border border-white/20 max-w-2xl">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-white">
      ...
      <div className="grid grid-cols-2 gap-8 max-w-4xl w-full">
        <div className="col-span-2 p-6 bg-white/10 rounded-xl border border-green-400/40">
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <h1>Hello World!</h1>
        ...
        <div className="p-6 bg-white/10 rounded-xl border border-purple-400/40">
        ...
        <div className="p-6 bg-white/10 rounded-xl border border-yellow-400/40">
