export default function SideNote({
  ...
  return (
    <div className="mt-8 p-4 w-96 bg-indigo-950/80 backdrop-blur-sm text-gray-100 rounded-lg group border border-indigo-400/50 z-10 hover:bg-indigo-900/80 transition-all duration-300">
